...
function FindResult() {
  return (
    <div className="z-10 flex max-w-[600px] flex-col gap-4 text-white">
      ...
      <div className="z-10 flex max-w-[600px] flex-col items-start justify-start gap-2 rounded-lg bg-white/5 p-4 text-[13px] font-medium backdrop-blur-sm">
      ...
      <div className="z-10 flex max-w-[600px] flex-col items-start justify-start gap-2 rounded-lg bg-white bg-white/5 p-4 text-[13px] font-medium backdrop-blur-sm">
        <div className="flex items-start justify-start gap-2">
          <div className="rounded-lg border-[1px] border-green-500 bg-green-400 px-3 py-1.5">
            {" "}
